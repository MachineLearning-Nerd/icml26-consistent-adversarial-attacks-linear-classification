...
| `orx/claim-4-falsification-eligibility` | Mandatory assumption-satisfying counterexample search | `uv sync --frozen && .venv/bin/python repro/src/verify.py` | Pending eligibility audit; invalid substitutions are rejected | Hugging Face `cpu-upgrade`, estimated 2 cores |
